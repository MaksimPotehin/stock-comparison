export const calculatorMessages = {
  ...
  description: 'Введіть початковий депозит, щомісячні внески та відсоткову ставку — і побачте, як зростають ваші інвестиції з часом.',
  results: 'Результати',
  form: {
  ...
  tableHeaders: {
    period: 'Період',
    date: 'Дата',
    accValue: 'Сума на рахунку',
    interestPerPeriod: 'Відсотки за період',
