  ...
  <div class="flex-shrink-0 border-r border-gray-500 pr-8">
    ...
    <div class="w-full max-w-[300px]">
      ...
      >
        ...
        <el-form-item class="flex-grow mb-0" label="Інфляція">
          <el-input v-model.number="modelValue.inflation" class="mb-2" />
        </el-form-item>
      </el-form>
    </div>
  </div>
...
const depositLabel = computed(() => modelValue.value.frequency === 'weekly' ? 'Щотижневий' : 'Щомісячний')
</script>
